...
public class ExecutivesController {
    ...
    public ResponseEntity<BaseResponse> addExecutives(
        ...
        BaseResponse baseResponse = executivesService.addExecutives(name, role, studentId, imagePath);
    ...
    public ResponseEntity<ExecutivesDTO> updateExecutives(
        ...
        ExecutivesDTO executive = executivesService.updateExecutives(id, name, role, studentId, imagePath);
